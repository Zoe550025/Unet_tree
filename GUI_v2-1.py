...
img_size = 300
div_size = img_size * 2
div1 = tk.Frame(window, width=div_size, height=div_size, bg='#b2d0b4')
div2 = tk.Frame(window, width=div_size, height=div_size, bg='#b2d0b4')
div3 = tk.Frame(window, width=div_size, height=div_size, bg='#b2d0b4')
div4 = tk.Frame(window, width=div_size, height=img_size, bg='#b2d0b4')
div5 = tk.Frame(window, width=div_size, height=div_size, bg='#b2d0b4')
div6 = tk.Frame(window, width=div_size, height=img_size, bg='#b2d0b4')
div7 = tk.Frame(window, width=div_size, height=div_size, bg='#b2d0b4')
div8 = tk.Frame(window, width=div_size, height=div_size, bg='#b2d0b4')
...
image_main = tk.Label(div7, image=imTK, bg='#b2d0b4')
...
image_unet = tk.Label(div8, image=imTK_unet, bg='#b2d0b4')
...
'''upload and start'''
upload_bt = tk.Button(div4, bd=3, height=2, text='Upload',bg='#c3bcb3', fg='Black', relief="raised",activebackground='#9b8975', activeforeground="green",
                      command=openfile )
upload_bt.grid(column=0, row=1, sticky=align_mode)

start_bt = tk.Button(div4, bd=3, height=2, text='Start',bg='#c3bcb3', fg='Black', relief="raised",activebackground='#9b8975', activeforeground="green",
                     command=start)
...
'''page'''
back_bt = tk.Button(div6, bd=3, height=2, text='<',bg='#c3bcb3', fg='Black',activebackground='#9b8975', activeforeground="green", command=back)
back_bt.grid(column=2, row=0, sticky=align_mode)

next_bt = tk.Button(div6, bd=3, height=2, text='>',bg='#c3bcb3', fg='Black',activebackground='#9b8975', activeforeground="green", command=next)
next_bt.grid(column=4, row=0, sticky=align_mode)

page_text = tk.StringVar()
page_text.set(" / ")
page_lb = tk.Label(div6, textvariable=page_text, fg='black', bg='#b2d0b4')
